...
public class BlackJackController implements Initializable {
	...
	private int iAnimationLength = 1000;
	...
	public void btnHit_Click(ActionEvent event) {
		...
		seqDeal.setInterpolator(Interpolator.LINEAR);
	...
	private Point2D FindPoint(HBox hBoxCard, int iCardNbr) {
		...
		Point2D pntCardDealt = new Point2D(bndCardDealt.getMinX() + iCardNbr + bndCardDealt.getWidth() * .45, bndCardDealt.getMinY() + bndCardDealt.getHeight() / 2);
	...
	private ParallelTransition createFadeTransition(final ImageView imgVFadeOut, final Image imgFadeIn) {
		...
		FadeTransition fadeOutTransition = new FadeTransition(Duration.millis(10), imgVFadeOut);
		...
		FadeTransition fadeInTransition = new FadeTransition(Duration.millis(10), imgVFadeOut);
